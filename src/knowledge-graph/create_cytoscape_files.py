...
def create_cytoscape_json(nodes_dict: Dict[str, dict], edges: List[dict], output_file: str):
    ...
    # Create nodes array with only referenced nodes
    cytoscape_nodes = []
    ...
    print(f"Created {output_file} with {len(cytoscape_nodes)} nodes and {len(cytoscape_edges)} edges")
...
def main():
    ...
    for csv_file in csv_files:
        ...
        name_part = base_name.replace("antijoin_", "").replace(".csv", "")  # alzheimers_llm_rag
